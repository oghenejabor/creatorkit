...
import { generateTiktokVoiceover, type GenerateTiktokVoiceoverOutput } from '@/ai/flows/generate-tiktok-voiceover';
...
const LOCAL_STORAGE_KEY = "tiktokVoiceoverResult";
...
export default function TiktokVoiceoverGeneratorPageClient() {
  const [isLoading, setIsLoading] = useState(false);
  const [result, setResult] = useState<GenerateTiktokVoiceoverOutput | null>(null);
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      const res = await generateTiktokVoiceover(values);
      setResult(res);
      setIsResultOpen(true);
  ...
  return (
    <div className="container mx-auto min-h-screen px-4 py-8">
      <header className="mb-12 text-center">
        ...
        <p className="mt-2 text-lg text-muted-foreground">Generate engaging voiceover text for your short-form videos.</p>
      </header>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <CardHeader>
                ...
                <CardDescription>Describe your video topic and optionally, a desired voiceover style.</CardDescription>
              </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Textarea placeholder="e.g., 'A quick tutorial on how to make the perfect cold brew coffee at home'" {...field} rows={4} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
        ...
        {result && (
          <Dialog open={isResultOpen} onOpenChange={setIsResultOpen}>
            <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col">
              <DialogHeader>
                <DialogTitle className="text-2xl font-headline">Generated Voiceover Text</DialogTitle>
                 <div className="flex justify-between items-center">
                    <DialogDescription>Your voiceover text is ready to be recorded.</DialogDescription>
              ...
              <ScrollArea className="flex-grow overflow-y-auto pr-4 -mr-4 mt-4 p-4 border rounded-lg bg-secondary/50">
                <p className="font-medium whitespace-pre-wrap">{result.voiceover}</p>
              </ScrollArea>
              <DialogFooter>
